...
const dashboardLinks = [
  ...
  { href: '/app/dashboard/bookings', label: 'Bookings', icon: <CalendarDays className="h-4 w-4" /> },
  { href: '/app/dashboard/availability', label: 'Availability', icon: <Clock className="h-4 w-4" /> },
