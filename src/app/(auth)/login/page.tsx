...
export default function LoginPage() {
  return (
    <Suspense fallback={<GlassCard variant="strong" padding="lg" className="w-full max-w-md h-80 animate-pulse" />}>
      <LoginForm />
    </Suspense>
  );
}
...
function LoginForm() {
  ...
  return (
    <GlassCard variant="strong" padding="lg" className="w-full max-w-md">
      ...
      {authError && (
        <FormError
          message={errorMessages[authError] ?? errorMessages.Default}
          className="mt-4"
        />
      )}
