...
export default async function DashboardOverviewPage() {
  ...
  const statCards = [
    { label: 'Tattoos', value: stats.totalTattoos, icon: Images, href: '/dashboard/portfolio' },
    { label: 'Bookings', value: stats.totalBookings, icon: CalendarDays, href: '/dashboard/bookings' },
    { label: 'Pending', value: stats.pendingBookings, icon: Clock, href: '/dashboard/bookings?status=PENDING' },
